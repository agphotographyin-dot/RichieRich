  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header Banner */}
        <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-950 p-7 text-white text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-36 h-36 bg-purple-400/10 rounded-full blur-2xl pointer-events-none" />
          <div className="relative z-10 flex flex-col items-center">
            <div className="w-14 h-14 rounded-2xl bg-purple-950/80 border border-purple-700/60 text-amber-400 flex items-center justify-center mb-3 shadow-lg">
              <Crown className="w-7 h-7" />
            </div>
            <h2 className="text-xl font-extrabold tracking-tight">Richie Rich Pan House</h2>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 mt-2 rounded-full bg-purple-950/90 border border-purple-700/60 text-purple-200 text-xs font-bold uppercase tracking-wider">
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                pattern="[0-9]{10}"
                maxLength={10}
                className="w-full bg-slate-50 border border-slate-300 focus:border-purple-600 focus:bg-white rounded-xl pl-16 pr-4 py-2.5 text-sm font-semibold font-mono text-slate-900 placeholder:text-slate-400 placeholder:font-sans transition-colors focus:outline-hidden"
              />
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-300 focus:border-purple-600 focus:bg-white rounded-xl pl-10 pr-4 py-2.5 text-sm font-semibold text-slate-900 placeholder:text-slate-400 transition-colors focus:outline-hidden"
              />
            </div>
          </div>

          {/* Welcome Bonus Callout */}
          <div className="p-3 bg-purple-50 rounded-xl border border-purple-200 flex items-center gap-2.5">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white rounded-xl font-bold text-sm shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer mt-2"
          >
            {isLoading ? (
          ...
          <div className="pt-3 border-t border-slate-100 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="p-2 text-left rounded-lg bg-slate-50 hover:bg-purple-50 hover:border-purple-200 border border-slate-200 text-xs transition-colors cursor-pointer"
              >
                <div className="font-bold text-slate-800">Rajesh Sharma</div>
                <div className="text-[10px] text-purple-700 font-mono">9820199882 (Platinum)</div>
              </button>
              ...
              >
                ...
                <div className="text-[10px] text-purple-700 font-mono">9876543210 (Gold)</div>
              </button>
            </div>
          </div>
        </form>
